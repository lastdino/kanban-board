            ...
            <div >
                ...
                <div  x-show="selectedTab === 'task'">
                    <div class="space-y-6 mt-6">
                        ...
                        <flux:select wire:model.blur="assigned_user" label="担当者" placeholder="担当者を選択">
                        ...
                        @if($task)
                            <flux:field>
                                ...
                                <div class="flex gap-2 flex-wrap">
                                    <flux:button variant="subtle" icon="plus" size="sm" tooltip="レビュワーを追加"  wire:click="openReviewerModal"/>
                            ...
                            <flux:field>
                                ...
                                <div class="flex gap-2 flex-wrap">
                                    <flux:button variant="subtle" icon="plus" size="sm" tooltip="フォロワーを追加"  wire:click="openFollowerModal"/>
                            ...
                            <flux:field>
                                ...
                                <div class="flex gap-2 flex-wrap">
                                    <flux:button variant="subtle" icon="plus" size="sm" tooltip="タグを追加"  wire:click="openTagModal"/>
                                    @if($task)
